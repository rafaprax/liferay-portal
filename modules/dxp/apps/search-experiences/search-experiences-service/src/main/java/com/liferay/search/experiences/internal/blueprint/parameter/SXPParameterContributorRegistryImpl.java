 ...
 */
@Component(enabled = false, service = SXPParameterContributorRegistry.class)
public class SXPParameterContributorRegistryImpl
	implements SXPParameterContributorRegistry {
