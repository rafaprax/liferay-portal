 ...
 */
@Generated("")
@GraphQLName("SchemaAttribute")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "SchemaAttribute")
public class SchemaAttribute implements Serializable {

	public static SchemaAttribute toDTO(String json) {
		return ObjectMapperUtil.readValue(SchemaAttribute.class, json);
	}

	public static SchemaAttribute unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(SchemaAttribute.class, json);
	}

	@Schema(
		description = "A list of canonical values.", example = "[work, home]"
	)
	...
	@GraphQLField(description = "A list of canonical values.")
	...
	@Schema(
		...
		example = "Unique identifier for the User, typically used by the user to directly authenticate to the service provider."
	)
	...
	@GraphQLField(description = "A description of the attribute.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	@Schema(
		description = "A boolean value indicating whether the attribute is multi-valued.",
		example = "false"
	)
	...
	@Schema(description = "The attribute's mutability.", example = "readWrite")
	@Valid
	...
	@GraphQLField(description = "The attribute's mutability.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	@Schema(description = "The attribute's name.", example = "userName")
	...
	@Schema(
		description = "A list of reference types.", example = "[User, Group]"
	)
	...
	@GraphQLField(description = "A list of reference types.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	@JsonGetter("returned")
	@Schema(
		description = "The attribute's returned characteristics.",
		example = "default"
	)
	@Valid
	...
	@GraphQLField(description = "The attribute's returned characteristics.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	@Schema(
		description = "A complex attribute that contains the attribute's sub-attributes."
	)
	@Valid
	...
	@JsonGetter("type")
	@Schema(description = "The attribute's data type.", example = "string")
	@Valid
	public Type getType() {
	...
	@GraphQLField(description = "The attribute's data type.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	protected Type type;
	...
	@Schema(description = "The attribute's uniqueness.", example = "server")
	@Valid
	...
	@GraphQLField(description = "The attribute's uniqueness.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	public boolean equals(Object object) {
		...
		SchemaAttribute schemaAttribute = (SchemaAttribute)object;

		return Objects.equals(toString(), schemaAttribute.toString());
	}
	...
	@Schema(
		...
		defaultValue = "com.liferay.scim.rest.dto.v1_0.SchemaAttribute",
		name = "x-class-name"
	)
