...
import com.liferay.scim.rest.client.serdes.v1_0.SchemaAttributeSerDes;
 ...
 */
@Generated("")
public class SchemaAttribute implements Cloneable, Serializable {

	public static SchemaAttribute toDTO(String json) {
		return SchemaAttributeSerDes.toDTO(json);
	}
	...
	@Override
	public SchemaAttribute clone() throws CloneNotSupportedException {
	...
	public String toString() {
		return SchemaAttributeSerDes.toJSON(this);
	}
