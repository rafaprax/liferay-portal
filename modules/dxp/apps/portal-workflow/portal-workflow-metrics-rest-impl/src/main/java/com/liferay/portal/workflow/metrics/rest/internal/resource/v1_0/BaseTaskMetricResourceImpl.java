...
@Generated("")
@Path("/v1.0")
public abstract class BaseTaskMetricResourceImpl implements TaskMetricResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/portal-workflow-metrics/v1.0/processes/{processId}/tasks/metrics'  -u 'test@liferay.com:test'
	 */
	@Override
	@GET
	@Parameters(
	...
	@Path("/processes/{processId}/tasks/metrics")
	@Produces({"application/json", "application/xml"})
	@Tags(value = {@Tag(name = "TaskMetric")})
	...
	protected void preparePatch(
		TaskMetric taskMetric, TaskMetric existingTaskMetric) {
	}
