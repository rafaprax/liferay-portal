...
import com.liferay.portal.workflow.metrics.rest.dto.v1_0.TaskMetric;
...
import com.liferay.portal.workflow.metrics.rest.resource.v1_0.TaskMetricResource;
...
public class Query {
	...
	public static void setTaskMetricResourceComponentServiceObjects(
		ComponentServiceObjects<TaskMetricResource>
			taskMetricResourceComponentServiceObjects) {

		_taskMetricResourceComponentServiceObjects =
			taskMetricResourceComponentServiceObjects;
	}
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {processAssigneeMetrics(completed: ___, dateEnd: ___, dateStart: ___, keywords: ___, page: ___, pageSize: ___, processId: ___, roleIds: ___, sorts: ___, taskKeys: ___){items {__}, page, pageSize, totalCount}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
	public AssigneeMetricPage processAssigneeMetrics(
			@GraphQLName("processId") Long processId,
		...
		return _applyComponentServiceObjects(
			_assigneeMetricResourceComponentServiceObjects,
			this::_populateResourceContext,
			assigneeMetricResource -> new AssigneeMetricPage(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {processInstance(instanceId: ___, processId: ___){assetTitle, assetType, assignees, className, classPK, completed, creator, dateCompletion, dateCreated, dateModified, description, duration, id, instance, processId, processVersion, slaResults, slaStatus, status, taskNames, transitions}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {processTask(processId: ___, taskId: ___){assigneeId, className, classPK, completed, completionUserId, dateCompletion, dateCreated, dateModified, description, duration, id, instanceId, label, name, processId, processVersion, tokenId}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {processTaskMetrics(completed: ___, dateEnd: ___, dateStart: ___, key: ___, page: ___, pageSize: ___, processId: ___, sorts: ___){items {__}, page, pageSize, totalCount}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
	public TaskMetricPage processTaskMetrics(
			@GraphQLName("processId") Long processId,
			@GraphQLName("completed") Boolean completed,
			@GraphQLName("dateEnd") Date dateEnd,
			@GraphQLName("dateStart") Date dateStart,
		...
		return _applyComponentServiceObjects(
			_taskMetricResourceComponentServiceObjects,
			this::_populateResourceContext,
			taskMetricResource -> new TaskMetricPage(
				taskMetricResource.getProcessTaskMetricsPage(
					processId, completed, dateEnd, dateStart, key,
					Pagination.of(page, pageSize),
					_sortsBiFunction.apply(taskMetricResource, sortsString))));
	}
	...
	@GraphQLTypeExtension(Process.class)
	public class GetProcessAssigneesPageTypeExtension {

		public GetProcessAssigneesPageTypeExtension(Process process) {
			_process = process;
		}
	...
	@GraphQLTypeExtension(Process.class)
	public class GetProcessAssigneeMetricsPageTypeExtension {

		public GetProcessAssigneeMetricsPageTypeExtension(Process process) {
			_process = process;
		}

		@GraphQLField
		public AssigneeMetricPage assigneeMetrics(
				@GraphQLName("completed") Boolean completed,
				@GraphQLName("dateEnd") Date dateEnd,
				@GraphQLName("dateStart") Date dateStart,
				@GraphQLName("keywords") String keywords,
	...
	@GraphQLTypeExtension(Process.class)
	public class GetProcessTaskMetricsPageTypeExtension {

		public GetProcessTaskMetricsPageTypeExtension(Process process) {
			_process = process;
		}

		@GraphQLField
		public TaskMetricPage taskMetrics(
				@GraphQLName("completed") Boolean completed,
				@GraphQLName("dateEnd") Date dateEnd,
				@GraphQLName("dateStart") Date dateStart,
				@GraphQLName("key") String key,
			...
			return _applyComponentServiceObjects(
				...
				taskMetricResource -> new TaskMetricPage(
					taskMetricResource.getProcessTaskMetricsPage(
						...
						Pagination.of(page, pageSize),
						_sortsBiFunction.apply(
							taskMetricResource, sortsString))));
		}
	...
	@GraphQLName("AssigneeMetricPage")
	public class AssigneeMetricPage {

		public AssigneeMetricPage(Page assigneeMetricPage) {
			actions = assigneeMetricPage.getActions();
			items = assigneeMetricPage.getItems();
			lastPage = assigneeMetricPage.getLastPage();
			page = assigneeMetricPage.getPage();
			pageSize = assigneeMetricPage.getPageSize();
			totalCount = assigneeMetricPage.getTotalCount();
		}
		...
		@GraphQLField
		protected java.util.Collection<AssigneeMetric> items;
	...
	@GraphQLName("TaskMetricPage")
	public class TaskMetricPage {

		public TaskMetricPage(Page taskMetricPage) {
			actions = taskMetricPage.getActions();
			items = taskMetricPage.getItems();
			lastPage = taskMetricPage.getLastPage();
			page = taskMetricPage.getPage();
			pageSize = taskMetricPage.getPageSize();
			totalCount = taskMetricPage.getTotalCount();
		}
		...
		@GraphQLField
		protected java.util.Collection<TaskMetric> items;
	...
	private void _populateResourceContext(TaskMetricResource taskMetricResource)
		throws Exception {

		taskMetricResource.setContextAcceptLanguage(_acceptLanguage);
		taskMetricResource.setContextCompany(_company);
		taskMetricResource.setContextHttpServletRequest(_httpServletRequest);
		taskMetricResource.setContextHttpServletResponse(_httpServletResponse);
		taskMetricResource.setContextUriInfo(_uriInfo);
		taskMetricResource.setContextUser(_user);
	}
	...
	private static ComponentServiceObjects<TaskResource>
		_taskResourceComponentServiceObjects;
	private static ComponentServiceObjects<TaskMetricResource>
		_taskMetricResourceComponentServiceObjects;
