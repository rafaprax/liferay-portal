...
public class ServletDataImpl implements ServletData {
	...
	public void activate(BundleContext bundleContext) {
		...
		Query.setAssigneeMetricResourceComponentServiceObjects(
		...
		Query.setTaskResourceComponentServiceObjects(
			_taskResourceComponentServiceObjects);
		Query.setTaskMetricResourceComponentServiceObjects(
	...
	@Reference(scope = ReferenceScope.PROTOTYPE_REQUIRED)
	private ComponentServiceObjects<TaskMetricResource>
		_taskMetricResourceComponentServiceObjects;
