 ...
 */
@Generated("")
public interface TaskMetricResource {
	...
	public HttpInvoker.HttpResponse getProcessTaskMetricsPageHttpResponse(
			Long processId, Boolean completed, java.util.Date dateEnd,
			java.util.Date dateStart, String key, Pagination pagination,
			String sortString)
		throws Exception;
	...
	public static class Builder {
		...
		public TaskMetricResource build() {
			return new TaskMetricResourceImpl(this);
		}
	...
	public static class TaskMetricResourceImpl implements TaskMetricResource {
		...
		public Page<TaskMetric> getProcessTaskMetricsPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getProcessTaskMetricsPageHttpResponse(
			...
			try {
				return Page.of(content, TaskMetricSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse getProcessTaskMetricsPageHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/portal-workflow-metrics/v1.0/processes/{processId}/tasks/metrics",
				processId);
		...
		private TaskMetricResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			TaskMetricResource.class.getName());
