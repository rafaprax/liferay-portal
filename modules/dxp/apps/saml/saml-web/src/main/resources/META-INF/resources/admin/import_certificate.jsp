...
<c:choose>
	...
	<c:otherwise>
		...
		<div class="container-fluid lfr-form-content">
			...
			<liferay-ui:error key="weakCertificateAlgorithm" message="the-certificate-does-not-meet-fips-140-3-requirements-only-rsa-keys-with-2048-bits-or-more-are-allowed" />
