...
public class DDMNavigationHelperImpl implements DDMNavigationHelper {
	...
	public boolean startsOnEditStructures(
		...
		return isStartedOn(liferayPortletRequest, _NAVIGATION_START_POINT_EDIT_STRUCTURE);
	}

	public boolean startsOnSelectStructures(
			LiferayPortletRequest liferayPortletRequest) {
		
		return isStartedOn(liferayPortletRequest, _NAVIGATION_START_POINT_SELECT_STRUCTURE);
	}

	public boolean startsOnEditTemplates(
		LiferayPortletRequest liferayPortletRequest) {

		return isStartedOn(liferayPortletRequest, _NAVIGATION_START_POINT_EDIT_TEMPLATE);
	}

	public boolean startsOnSelectTemplates(
			LiferayPortletRequest liferayPortletRequest) {
		
		return isStartedOn(liferayPortletRequest, _NAVIGATION_START_POINT_SELECT_TEMPLATE);
	}

	public boolean startsOnStructures(
		LiferayPortletRequest liferayPortletRequest) {

		return isStartedOn(liferayPortletRequest, _NAVIGATION_START_POINT_STRUCTURE);
	}

	public boolean startsOnTemplates(
		LiferayPortletRequest liferayPortletRequest) {

		return isStartedOn(liferayPortletRequest, _NAVIGATION_START_POINT_TEMPLATE);
	}
	
	private boolean isStartedOn(LiferayPortletRequest liferayPortletRequest, String startPoint) {
