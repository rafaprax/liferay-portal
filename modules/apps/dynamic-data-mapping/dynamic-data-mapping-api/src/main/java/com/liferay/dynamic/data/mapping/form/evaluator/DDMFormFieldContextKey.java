 ...
 */
public class DDMFormFieldContextKey {

	public DDMFormFieldContextKey(String fieldName, String instanceId) {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof DDMFormFieldContextKey)) {
			return false;
		}

		DDMFormFieldContextKey ddmFormFieldContextKey =
			(DDMFormFieldContextKey)obj;
