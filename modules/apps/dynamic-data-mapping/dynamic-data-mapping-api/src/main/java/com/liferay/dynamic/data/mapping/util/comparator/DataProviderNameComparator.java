...
public class DataProviderNameComparator
	extends OrderByComparator<DDMDataProvider> {
	...
	@Override
	public int compare(
		DDMDataProvider ddmDataProvider1, DDMDataProvider ddmDataProvider2) {

		String name1 = StringUtil.toLowerCase(ddmDataProvider1.getName());
		String name2 = StringUtil.toLowerCase(ddmDataProvider2.getName());
