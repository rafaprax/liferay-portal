...
public class DDMFormInstanceLocalServiceUtil {
	...
	*/
	...
	public static com.liferay.dynamic.data.mapping.model.DDMFormInstance addFormInstance(
		...
		return getService()
				   .addFormInstance(userId, groupId, ddmStructureId,
	...
	*/
	...
	public static com.liferay.dynamic.data.mapping.storage.DDMFormValues getFormInstanceSettingsFormValues(
		com.liferay.dynamic.data.mapping.model.DDMFormInstance formInstance)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getFormInstanceSettingsFormValues(formInstance);
	}

	public static com.liferay.dynamic.data.mapping.model.DDMFormInstanceSettings getFormInstanceSettingsModel(
		com.liferay.dynamic.data.mapping.model.DDMFormInstance formInstance)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	...
	public static com.liferay.dynamic.data.mapping.model.DDMFormInstance updateFormInstance(
		...
		return getService()
			...
			structureDDMForm, structureDDMFormLayout, nameMap, descriptionMap,
	...
	public static com.liferay.dynamic.data.mapping.model.DDMFormInstance updateFormInstance(
		...
		return getService()
				   .updateFormInstance(ddmFormInstanceId, ddmStructureId,
			nameMap, descriptionMap, serializedSettingsDDMFormValues,
			serviceContext);
	}
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(DDMFormInstanceLocalService.class);

		ServiceTracker<DDMFormInstanceLocalService, DDMFormInstanceLocalService> serviceTracker =
			new ServiceTracker<DDMFormInstanceLocalService, DDMFormInstanceLocalService>(bundle.getBundleContext(),
