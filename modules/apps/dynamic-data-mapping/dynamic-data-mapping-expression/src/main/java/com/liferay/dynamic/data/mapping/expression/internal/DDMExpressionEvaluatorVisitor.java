...
public class DDMExpressionEvaluatorVisitor
	...
	public static class Builder {
		...
		public static Builder newBuilder(
			...
			return new Builder(ddmExpressionFunctions, variables);
		}

		public DDMExpressionEvaluatorVisitor build() {
			return _ddmExpressionEvaluatorVisitor;
		}
		...
		private Builder(
			...
			_ddmExpressionEvaluatorVisitor =
				new DDMExpressionEvaluatorVisitor();

			_ddmExpressionEvaluatorVisitor._ddmExpressionFunctions =
				ddmExpressionFunctions;
			_ddmExpressionEvaluatorVisitor._variables = variables;
		}

		private final DDMExpressionEvaluatorVisitor
			_ddmExpressionEvaluatorVisitor;
	...
	private DDMExpressionEvaluatorVisitor() {
	}
