...
public class AddFormInstanceRecordMVCCommandHelper {
	...
	protected Set<String> getInvisibleFields(
		...
		Set<Map.Entry<DDMFormFieldContextKey, Map<String, Object>>> entrySet =
			ddmFormFieldsPropertyChanges.entrySet();

		Stream<Map.Entry<DDMFormFieldContextKey, Map<String, Object>>> stream =
			entrySet.stream();
		...
		return stream.filter(
			...
			result -> {
				DDMFormFieldContextKey ddmFormFieldContextKey = result.getKey();
