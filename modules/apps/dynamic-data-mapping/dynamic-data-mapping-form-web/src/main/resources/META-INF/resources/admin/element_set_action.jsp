...
>
	...
	<c:if test="<%=ddmFormAdminPermissionCheckerHelper.isShowEditIcon(ddmStructure)%>">
	...
	<c:if test="<%=ddmFormAdminPermissionCheckerHelper.isShowPermissionsIcon(ddmStructure)%>">
	...
	<c:if test="<%=ddmFormAdminPermissionCheckerHelper.isShowDeleteIcon(ddmStructure)%>">
