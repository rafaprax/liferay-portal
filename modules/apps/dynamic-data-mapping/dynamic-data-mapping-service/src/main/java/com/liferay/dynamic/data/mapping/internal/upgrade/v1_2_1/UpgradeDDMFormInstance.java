...
public class UpgradeDDMFormInstance extends UpgradeProcess {
	...
	protected void doUpgrade() throws Exception {
		...
		upgradeResourcePermission(
			_OLD_ADMIN_PORTLET_NAME, _NEW_ADMIN_PORTLET_NAME);
		...
		try (PreparedStatement ps1 = connection.prepareStatement(
			...
			while (rs.next()) {
				...
				updateInstanceablePortletPreferences(
					recordSetId, _OLD_DISPLAY_PORTLET_NAME,
					_NEW_DISPLAY_PORTLET_NAME);
	...
	protected long getNewActionIds(
		...
		List<ResourceAction> newPortletmodelResourceActions =
			_resourceActionLocalService.getResourceActions(newName);

		collectNewActionIds(
			actionsIdsList, newPortletmodelResourceActions, currentActionIds);

		Stream<ResourceAction> resourceActionStream =
			newPortletmodelResourceActions.stream();
	...
	private static final String _NEW_ADMIN_PORTLET_NAME =
		"com_liferay_dynamic_data_mapping_form_web_portlet_DDMFormAdminPortlet";

	private static final String _NEW_DISPLAY_PORTLET_NAME =
	...
	private static final String _OLD_ADMIN_PORTLET_NAME =
