...
public class DDMFormBuilderContextFactoryHelper {
	...
	public DDMFormBuilderContextFactoryHelper(
		...
		Optional<DDMStructureVersion> ddmStructureOptionalVersion,
		...
		_ddmStructureOptionalVersion = ddmStructureOptionalVersion;
	...
	public Map<String, Object> create() {
		...
		if (_ddmStructureOptionalVersion.isPresent()) {
			contextOptional = _ddmStructureOptionalVersion.map(
	...
	private final Optional<DDMStructureVersion> _ddmStructureOptionalVersion;
