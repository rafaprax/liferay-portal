...
public class DDMFormEvaluatorRuleHelper {
	...
	public void checkActions(DDMFormRule ddmFormRule) {
		Collection<DDMFormField> fieldNameSet = _ddmFormFieldsMap.values();

		Stream<DDMFormField> stream = fieldNameSet.parallelStream();

		stream.forEach(field -> checkFieldActions(ddmFormRule, field));
	}

	protected void checkFieldActions(
		DDMFormRule ddmFormRule, DDMFormField ddmFormField) {

		checkSetReadOnlyAction(ddmFormRule, ddmFormField);
		checkSetRequiredAction(ddmFormRule, ddmFormField);
		checkSetVisibleAction(ddmFormRule, ddmFormField);
	}

	protected void checkSetReadOnlyAction(
		DDMFormRule ddmFormRule, DDMFormField ddmFormField) {
	...
	protected void checkSetRequiredAction(
		DDMFormRule ddmFormRule, DDMFormField ddmFormField) {
	...
	protected void checkSetVisibleAction(
		DDMFormRule ddmFormRule, DDMFormField ddmFormField) {
