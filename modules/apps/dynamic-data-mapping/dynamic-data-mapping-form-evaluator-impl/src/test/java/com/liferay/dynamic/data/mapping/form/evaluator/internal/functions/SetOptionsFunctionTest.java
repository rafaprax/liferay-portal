...
public class SetOptionsFunctionTest extends PowerMockito {
	...
	public void testApply() {
		...
		Boolean result = _setOptionsFunction.apply(spy, "optionList", json);
		...
		Assert.assertEquals(
			"options", updateFieldPropertyRequest.getProperty());
		...
		Assert.assertEquals(
			keyValuePairs, updateFieldPropertyRequest.getValue());
	...
	public void testInvalidJSON() {
		...
		Boolean result = _setOptionsFunction.apply(
			spy, "optionList", "INVALID");
	...
	public void testIsObservable() {
		Assert.assertTrue(_setOptionsFunction.isObservable());
	}

	@Test
	public void testNullObserver() {
		Assert.assertFalse(_setOptionsFunction.apply(null, "field", "json"));
	}
