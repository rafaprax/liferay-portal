 ...
 */
@Component(immediate = true, property = "ddm.form.field.type.name=fieldset")
public class FieldSetDDMFormFieldRenderer implements DDMFormFieldRenderer {
	...
	private static final String _TEMPLATE_NAMESPACE = "DDMFieldset.render";
