...
@Meta.OCD(
	id = "com.liferay.mail.outlook.auth.connector.provider.internal.configuration.OutlookAuthConnectorCompanyConfiguration",
	localization = "content/Language",
	name = "outlook-auth-connector-configuration-name"
)
public interface OutlookAuthConnectorCompanyConfiguration {
