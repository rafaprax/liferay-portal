...
public class KaleoTaskInstanceTokenModelDocumentContributor
	...
	public void contribute(
		...
		document.addText(
			KaleoTaskInstanceTokenField.KALEO_TASK_NAME,
		...
		for (String titleLanguageId : titleLanguageIds) {
			if (titleLanguageId.equals(siteDefaultLanguageId)) {
				document.addText(
		...
		for (String descriptionLanguageId : descriptionLanguageIds) {
			if (descriptionLanguageId.equals(siteDefaultLanguageId)) {
				document.addText(
					KaleoTaskInstanceTokenField.ASSET_TITLE,
					assetEntry.getTitle(descriptionLanguageId));
			}
