		...
		for (Element actionElement : actionElements) {
			...
			if (actionElement.element("script") != null) {
				actions.add(new ScriptAction(
					...
					actionElement.elementTextTrim("script-language"),
					actionElement.elementTextTrim("script-required-contexts"),
					priority));
			}
			else if (actionElement.element("status") != null) {
				actions.add(new UpdateStatusAction(
					name, description, executionType,
					GetterUtil.getInteger(actionElement.elementText("status")),
					priority));
			}
		}
