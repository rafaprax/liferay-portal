...
public class WorkflowTaskAssignableUserSerDes {
	...
	public static String toJSON(
		...
		if (workflowTaskAssignableUser.getTaskId() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(workflowTaskAssignableUser.getTaskId());
		}
	...
	public static Map<String, String> toMap(
		...
		if (workflowTaskAssignableUser.getTaskId() == null) {
			...
			map.put(
				"taskId",
				String.valueOf(workflowTaskAssignableUser.getTaskId()));
		}
	...
	public static class WorkflowTaskAssignableUserJSONParser
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "assignableUsers")) {
				...
				if (jsonParserFieldValue != null) {
					workflowTaskAssignableUser.setTaskId(
