...
public class WorkflowTaskAssignToUserSerDes {
	...
	public static String toJSON(
		...
		if (workflowTaskAssignToUser.getTaskId() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(workflowTaskAssignToUser.getTaskId());
		}
	...
	public static Map<String, String> toMap(
		...
		if (workflowTaskAssignToUser.getTaskId() == null) {
			...
			map.put(
				"taskId", String.valueOf(workflowTaskAssignToUser.getTaskId()));
		}
	...
	public static class WorkflowTaskAssignToUserJSONParser
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "assigneeId")) {
				...
				if (jsonParserFieldValue != null) {
					workflowTaskAssignToUser.setTaskId(
						Long.valueOf((String)jsonParserFieldValue));
				}
			}
			else {
