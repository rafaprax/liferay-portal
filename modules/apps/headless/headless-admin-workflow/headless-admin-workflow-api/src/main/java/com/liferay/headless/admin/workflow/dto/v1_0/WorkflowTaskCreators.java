 ...
 */
@Generated("")
@GraphQLName("WorkflowTaskCreators")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "WorkflowTaskCreators")
public class WorkflowTaskCreators {
	...
	@Schema(
		defaultValue = "com.liferay.headless.admin.workflow.dto.v1_0.WorkflowTaskCreators",
		name = "x-class-name"
	)
