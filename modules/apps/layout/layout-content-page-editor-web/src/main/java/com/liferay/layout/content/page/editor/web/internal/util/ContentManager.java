...
public class ContentManager {
	...
	protected void activate() {
		_assetListEntryUsagesManager = new AssetListEntryUsagesManager();
	...
	private class AssetListEntryUsagesManager {

		public AssetListEntryUsagesManager() {
		...
		public JSONArray getPageContentsJSONArray(
			...
			for (AssetListEntryUsage assetListEntryUsage :
					_assetListEntryUsageLocalService.
						getAssetEntryListUsagesByPlid(plid)) {
		...
		private List<AssetPublisherAddItemHolder>
				_getAssetPublisherAddItemHolders(
					AssetListEntry assetListEntry,
					HttpServletRequest httpServletRequest,
					HttpServletResponse httpServletResponse)
		...
		private final long _collectionStyledLayoutStructureItemClassNameId;
