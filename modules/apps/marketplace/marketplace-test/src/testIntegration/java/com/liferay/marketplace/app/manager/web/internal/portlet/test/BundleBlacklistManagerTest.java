...
public class BundleBlacklistManagerTest {
	...
	public void setUp() throws Exception {
		Bundle bundle = FrameworkUtil.getBundle(
			BundleBlacklistManagerTest.class);
		...
		_bundleBlacklistManager = ReflectionTestUtil.getFieldValue(
			_marketplaceAppManagerPortlet, "_bundleBlacklistManager");
	}
	...
	public void tearDown() throws Exception {
		...
		_bundleBlacklistConfiguration.update(_properties);

		CountDownLatch updateDownLatch = new CountDownLatch(1);

		ServiceRegistration<EventHandler> eventHandlerServiceRegistration =
			_bundleContext.registerService(
				EventHandler.class, event -> updateDownLatch.countDown(),
	...
	public void testAddToAndRemoveFromBlacklist() throws Exception {
		...
		ReflectionTestUtil.invoke(
			...
			new Object[] {new String[] {_SYMBOLIC_NAME}});
	...
	private Collection<String> _getBlacklistBundleSymbolicNames() {
		Dictionary<String, Object> properties =
			_bundleBlacklistConfiguration.getProperties();
	...
	private Object _bundleBlacklistManager;
	...
	private Portlet _marketplaceAppManagerPortlet;
