 ...
 */
public class UpgradeDDMDateFieldValueFormatPreferences
	...
	protected String getUpdatePortletPreferencesWhereClause() {
		...
		sb.append("(preferences like '%subtypeFieldsFilterEnabled%");
		sb.append(Boolean.TRUE.toString());
		sb.append("%') or (preferences like '%subtypeFieldsFilterEnabled%");
