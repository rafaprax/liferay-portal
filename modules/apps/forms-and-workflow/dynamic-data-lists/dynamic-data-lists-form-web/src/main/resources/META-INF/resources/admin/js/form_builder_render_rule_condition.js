			...
			_getConditions: function() {
				...
				for (var i = 0; i < instance._conditionsIndexes.length; i++) {
						...
						'operands': [
							{
								...
								type: instance._getFirstOperandValue(index) === 'user' ? 'user' : 'field',
					...
					if (instance._isBinaryCondition(index)) {
						if (instance._getSecondOperandTypeValue(index) === 'field') {
						...
						else if (instance._getSecondOperandTypeValue(index) === 'constant') {
							...
							condition.operands.push(
								{
									type: 'constant',
									value: instance._getSecondOperandTypeValue(index)
								}
							);
						}
					}
