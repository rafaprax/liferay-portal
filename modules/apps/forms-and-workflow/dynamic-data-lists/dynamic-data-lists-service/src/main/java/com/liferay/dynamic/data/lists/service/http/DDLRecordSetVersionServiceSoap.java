...
public class DDLRecordSetVersionServiceSoap {
	public static com.liferay.dynamic.data.lists.model.DDLRecordSetVersionSoap getDDLRecordSetVersion(
		long recordSetVersionId) throws RemoteException {
		try {
			com.liferay.dynamic.data.lists.model.DDLRecordSetVersion returnValue =
				DDLRecordSetVersionServiceUtil.getDDLRecordSetVersion(recordSetVersionId);
	...
	public static com.liferay.dynamic.data.lists.model.DDLRecordSetVersionSoap[] getDDLRecordSetVersions(
		...
		try {
			java.util.List<com.liferay.dynamic.data.lists.model.DDLRecordSetVersion> returnValue =
				DDLRecordSetVersionServiceUtil.getDDLRecordSetVersions(recordSetId,
	...
	public static int getDDLRecordSetVersionsCount(long recordSetId)
		throws RemoteException {
		try {
			int returnValue = DDLRecordSetVersionServiceUtil.getDDLRecordSetVersionsCount(recordSetId);
