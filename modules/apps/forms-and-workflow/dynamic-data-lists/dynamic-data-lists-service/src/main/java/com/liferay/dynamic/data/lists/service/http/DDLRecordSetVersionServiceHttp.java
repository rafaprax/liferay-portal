...
public class DDLRecordSetVersionServiceHttp {
	public static com.liferay.dynamic.data.lists.model.DDLRecordSetVersion getDDLRecordSetVersion(
		...
		try {
			MethodKey methodKey = new MethodKey(DDLRecordSetVersionServiceUtil.class,
					...
					_getDDLRecordSetVersionParameterTypes0);
	...
	public static java.util.List<com.liferay.dynamic.data.lists.model.DDLRecordSetVersion> getDDLRecordSetVersions(
		...
		try {
			MethodKey methodKey = new MethodKey(DDLRecordSetVersionServiceUtil.class,
					...
					_getDDLRecordSetVersionsParameterTypes1);
	...
	public static int getDDLRecordSetVersionsCount(
		...
		try {
			MethodKey methodKey = new MethodKey(DDLRecordSetVersionServiceUtil.class,
					...
					_getDDLRecordSetVersionsCountParameterTypes2);
	...
	public static com.liferay.dynamic.data.lists.model.DDLRecordSetVersion getLatestRecordSetVersion(
		...
		try {
			MethodKey methodKey = new MethodKey(DDLRecordSetVersionServiceUtil.class,
					...
					_getLatestRecordSetVersionParameterTypes3);
	...
	private static final Class<?>[] _getDDLRecordSetVersionParameterTypes0 = new Class[] {
			long.class
		};
	private static final Class<?>[] _getDDLRecordSetVersionsParameterTypes1 = new Class[] {
			long.class, int.class, int.class,
			com.liferay.portal.kernel.util.OrderByComparator.class
		};
	private static final Class<?>[] _getDDLRecordSetVersionsCountParameterTypes2 =
		new Class[] { long.class };
	private static final Class<?>[] _getLatestRecordSetVersionParameterTypes3 = new Class[] {
			long.class
		};
}