...
public class DDMStructureVersionLocalServiceUtil {
	...
	*/
	...
	public static com.liferay.dynamic.data.mapping.model.DDMStructureVersion addStructureVersion(
		...
		return getService()
				   .addStructureVersion(userId, parentStructureId, nameMap,
			descriptionMap, definition, version, structure, ddmFormLayout,
			serviceContext);
	}
	...
	*/
	...
	public static void deleteStructureVersion(long structureId)
		throws com.liferay.portal.kernel.exception.PortalException {
		getService().deleteStructureVersion(structureId);
	}
