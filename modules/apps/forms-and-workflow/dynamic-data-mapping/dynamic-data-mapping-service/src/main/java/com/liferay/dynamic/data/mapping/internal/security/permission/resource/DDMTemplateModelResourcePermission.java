...
public class DDMTemplateModelResourcePermission
	...
	public boolean contains(
		...
		String portletId = PortletProviderUtil.getPortletId(
			template.getClassName(), PortletProvider.Action.EDIT);

		if (Validator.isNotNull(portletId)) {
			Boolean hasPermission = _stagingPermission.hasPermission(
				permissionChecker, template.getGroupId(),
				structureModelResourceName, template.getTemplateId(), portletId,
				actionId);
		...
		if (permissionChecker.hasOwnerPermission(
				template.getCompanyId(), structureModelResourceName,
		...
		return permissionChecker.hasPermission(
			template.getGroupId(), structureModelResourceName,
			template.getTemplateId(), actionId);
	}
