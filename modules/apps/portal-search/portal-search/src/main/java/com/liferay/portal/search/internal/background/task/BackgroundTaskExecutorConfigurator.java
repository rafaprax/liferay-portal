...
public class BackgroundTaskExecutorConfigurator {
	...
	protected void activate(BundleContext bundleContext) {
		...
		_reindexSingleIndexerBackgroundTaskExecutor =
			new ReindexSingleIndexerBackgroundTaskExecutor(
				indexerRegistry, reindexStatusMessageSender, searchEngineHelper,
				systemIndexers);

		_reindexSingleIndexerBackgroundTaskExecutor.openIndexers(bundleContext);
	...
	protected void deactivate() {
		_reindexSingleIndexerBackgroundTaskExecutor.closeIndexers();
